...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'lenta_rss', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0d6e37ba08b9ada7aae96beccb0abe974273ff3e6af380dd11afdf12949f486d');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Handler\FeedHandler A AppBundle\Handler\FeedHandler instance
     */
    protected function getFeed_HandlerService()
    {
        return $this->services['feed.handler'] = new \AppBundle\Handler\FeedHandler($this->get('feedio'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('59be7c30ea56a5d25a1e8c267041f5246ee653fb');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58aea2473ca717.59000218')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '59be7c30ea56a5d25a1e8c267041f5246ee653fb',
            'locale' => 'en',
            ...
            'kernel.secret' => '59be7c30ea56a5d25a1e8c267041f5246ee653fb',
